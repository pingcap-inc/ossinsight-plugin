...
// RepoIDThisYearExists judge this repo id is exists in this year or not
func RepoIDThisYearExists(repoID int64) (bool, error) {
	yearKey := repoYearPrefix + strconv.Itoa(time.Now().Year())
	return HyperLogLogExists(yearKey, repoID)
}
